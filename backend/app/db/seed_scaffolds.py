...
_DEFAULT_SCAFFOLDS = [
    {
        ...
        "prompt_template": (
            ...
            "② 提出2–3个有助于我进一步思考的关键问题，帮我厘清______。"
        ),
        "sort_order": 1,
    },
    {
    ...
    },
    {
        ...
        "prompt_template": (
            "回顾整个与你的对话过程，请和我一起回顾以下几点：\n"
            "①我在哪个/哪些对话节点对问题的理解发生了明显变化；\n"
            "②你认为这一变化是由你的哪类回应或我使用的哪种提示语引发的；\n"
            "③这一变化对我最终方案或理解产生了怎样的影响；\n"
            "④我印象最深刻的一部分交互是______这部分内容。\n"
            "同时，请你补充一个可能被我忽略的变化节点或解释视角。"
        ),
        "sort_order": 4,
    },
]
